 ...
 */
class RemindCalendarItemAdapter(val data: MutableList<Reminder>):
        RecyclerView.Adapter<RemindCalendarItemAdapter.Companion.ViewHolder>(), MutableList<Reminder> by data {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.remind_calendar_item, parent, false)
